...
<div class="wrapper">
    ...
    <?php while($product = $listProducts->fetch_assoc()) {
      ?>
        <tr>
          ...
          <td><?php echo $product['sex']?"Men":"Falme"; ?></td>
          <td><?php echo $product['favioure']; ?></td>
          <td>
             <a href="edit_user.php?idEdit=<?php echo $product['id']?>">EDIT</a> 
            | <a href="delete_user.php?id=<?php echo $product['id']?>">DELETE</a>
  ...
  <div id="align-register-button">
    <a id="new-register" href="register.php"> Register</a>
  </div>
  </div>
  <!-- /.content-wrapper -->
